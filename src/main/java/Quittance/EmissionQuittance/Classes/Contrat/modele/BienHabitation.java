 ...
 * 
 */
public class BienHabitation extends BienAssure implements IEntite{
	...
	private Integer formuleChoisie;

	// Piscine
	private String piscine;

	public BienHabitation() {
		super();
		ojbConcreteClass = BienHabitation.class.getName();
	}
	...
	public Integer getFormuleChoisie() {
		return formuleChoisie;
	}

	public void setFormuleChoisie(Integer formuleChoisie) {
