...
public class ActiviteBmce extends ParametrageBO implements IEntite {
   private long id;
   ...
   private ActiviteBmce refActiviteSup;      //each Activite with parent==null is a root ActiviteBmce, all others are ActiviteBmce Fils

   @OneToMany //add column definitions as needed
   private List<ActiviteBmce> refActiviteFils;
...
public void setNiveau(String niveau) {
	...
	public ActiviteBmce getRefActiviteSup() {
	return refActiviteSup;
}

public void setRefActiviteSup(ActiviteBmce refActiviteSup) {
	this.refActiviteSup = refActiviteSup;
}

public List<ActiviteBmce> getRefActiviteFils() {
	return refActiviteFils;
}

public void setRefActiviteFils(List<ActiviteBmce> refActiviteFils) {
