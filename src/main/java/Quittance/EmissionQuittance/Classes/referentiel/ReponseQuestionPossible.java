...
public class ReponseQuestionPossible extends ParametrageBO implements IEntite {
	...
	public ReponseQuestionPossible() {
	...
	public void setRefQuestionDeclaration(QuestionDeclaration refQuestionDeclaration) {
		this.refQuestionDeclaration = refQuestionDeclaration;
	}
